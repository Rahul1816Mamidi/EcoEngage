...
import { Menu, Coins, Trees, Search, Bell, User, ChevronDown, LogIn, LogOut } from "lucide-react"
import { 
  DropdownMenu, 
  DropdownMenuContent, 
  DropdownMenuItem, 
...
const clientId = "BGYTIIxxXKQ_kEpOxxdHS9HKCLA8wBaF1fmTt8xSytxBSZbpLwJPQt55Sm7kO1IIU8QsB8SbRDbpYS2CcQZoTcM";
        ...
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            ...
            <div className="flex flex-col">
              <span className="font-bold text-base md:text-lg text-gray-800">EcoEngage</span>
              <span className="text-[8px] md:text-[10px] text-gray-500 -mt-1">TEAM VIRAT</span>
            </div>
          </Link>
        </div>
        {!isMobile && (
