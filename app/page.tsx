    ...
    <div className={`container mx-auto px-4 py-16 ${poppins.className}`}>
      <section className="text-center mb-20">
        ...
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
          Eco-Engage <br />
          <span className="text-4xl text-green-600">..not my garbage ,but my nation ..</span> <br />
          <span className="text-4xl font-bold text-orange-600">TEAM VIRAT</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-8">
          Solution for waste segregation and improved sanitation
        </p>
        {!loggedIn ? (
      ...
      <section className="grid md:grid-cols-3 gap-10 mb-20">
        <FeatureCard
          icon={Trees}
          title="Eco-Friendly"
          description="Make nation CLEAN by reporting and collecting waste."
        />
        <FeatureCard
          icon={Coins}
          title="Earn Rewards"
          description="win TOKENS for ur waste management efforts."
        />
        <FeatureCard
          icon={Users}
          title="Engage in community"
          description="Be the part of community that aims clean india ."
        />
      </section>
      ...
      <section className="bg-white p-10 rounded-3xl shadow-lg mb-20">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <ImpactCard title="CO2 Offset" value={`${impactData.co2Offset} kg`} icon={Trees} />
        </div>
      </section>
